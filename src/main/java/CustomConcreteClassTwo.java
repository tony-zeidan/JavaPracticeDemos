/**
 * This class represents another concrete implementation of the abstract
 ...
 * @version 12/18/2020
 */
public class CustomConcreteClassTwo extends CustomAbstractTemplate {

    /**
     * Amount factor that could be different for every subclass.
     */
    public static final double amountFactor = 100.0;
    /**
     ...
     */
    public CustomConcreteClassTwo(double initialAmount, double initialRate) {
