 ...
 * @version 12/19/2020
 */
public class CustomConcreteDecoratorB extends CustomDecorator {
     ...
     */
    public CustomConcreteDecoratorB(CustomComponent component) {
        super(component);
    }
    ...
    public String operation() {
        return super.operation() + " different because impl. B";
    }
}